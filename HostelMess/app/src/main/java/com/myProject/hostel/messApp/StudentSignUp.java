                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if(task.isSuccessful()){
                                   //progressDialog.dismiss();
                                    ...
                                    Log.e("error","myerr= "+task.getException().toString());
                                    progressDialog.dismiss();
    ...
    public Boolean validate(){
       ...
       // String studentH = studentHostel.getText().toString();
        ...
        if(studentN.isEmpty())
        {
           ...
           // progressDialog.dismiss();
        }else if(studentE.isEmpty()){
            Toast.makeText(this,"Please Enter Email Id",Toast.LENGTH_SHORT).show();
        }else if(!Patterns.EMAIL_ADDRESS.matcher(studentE).matches()){
            Toast.makeText(this,"Please Enter Valid Email Id",Toast.LENGTH_SHORT).show();
        }else if(studentP.isEmpty()){
            Toast.makeText(this,"Please Enter Student Password",Toast.LENGTH_SHORT).show();
        }else if(studentP.length()<6){
            Toast.makeText(this,"Password length must be greater than 6 character",Toast.LENGTH_SHORT).show();
        }        else if(studentRegn.isEmpty()){
            Toast.makeText(this,"Please Enter Registration No.",Toast.LENGTH_SHORT).show();
        }else if(studentH.compareTo("Select Hostel")==0){
            Toast.makeText(this,"Please Select Hostel",Toast.LENGTH_SHORT).show();
        }
        else if(studentR.isEmpty()){
            Toast.makeText(this,"Please Enter Room No.",Toast.LENGTH_SHORT).show();
        } else if(Integer.parseInt(studentR)==0){
            Toast.makeText(this,"Room number must be greater than 0",Toast.LENGTH_SHORT).show();
        }
        else if(studentM.isEmpty()){
            Toast.makeText(this,"Please Enter Mobile No.",Toast.LENGTH_SHORT).show();
        }else if(studentM.length()!=10){
            Toast.makeText(this,"Mobile number must be of 10 digit",Toast.LENGTH_SHORT).show();
