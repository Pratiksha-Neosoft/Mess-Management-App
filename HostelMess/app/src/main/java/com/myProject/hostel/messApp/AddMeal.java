    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tit.compareTo("Select Meal")==0){
                    Toast.makeText(AddMeal.this,"Select Meal Type",Toast.LENGTH_SHORT).show();
                }else if(desc.isEmpty()){
                    Toast.makeText(AddMeal.this,"Please enter Meal Title",Toast.LENGTH_SHORT).show();
                }else if(co.isEmpty()){
                    Toast.makeText(AddMeal.this,"Please Enter Cost",Toast.LENGTH_SHORT).show();

                }else if(Integer.parseInt(co)<0){
                    Toast.makeText(AddMeal.this,"Cost must be greater than 0",Toast.LENGTH_SHORT).show();

                }else if(d.isEmpty() ||d.compareTo("DATE")==0){
                    Toast.makeText(AddMeal.this,"Please Enter Date",Toast.LENGTH_SHORT).show();
                }
                else {
