        ...
        Sendbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(name.isEmpty()){
                    ...
                    Toast.makeText(Complaint.this,"Please Enter Email",Toast.LENGTH_SHORT).show();

                }else if(!Patterns.EMAIL_ADDRESS.matcher(Email).matches()){
                    Toast.makeText(Complaint.this,"Please Enter Valid Email",Toast.LENGTH_SHORT).show();

                }else if(Message.isEmpty()){
                    Toast.makeText(Complaint.this,"Please Enter Message",Toast.LENGTH_SHORT).show();
